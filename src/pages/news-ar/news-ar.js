...
var NewsPageAR = (function () {
    function NewsPageAR(navCtrl) {
        this.navCtrl = navCtrl;
        this.NewslandingPageAR = NewslandingPageAR;
        this.TheSpeakersPageAR = TheSpeakersPageAR;
    }
    NewsPageAR.prototype.scrollToTop = function () {
...
], NewsPageAR.prototype, "content", void 0);
NewsPageAR = __decorate([
    Component({
        selector: 'page-news',
...
export { NewsPageAR };
//# sourceMappingURL=news-ar.js.map