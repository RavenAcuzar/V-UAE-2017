...
var NewslandingPageID = (function () {
    function NewslandingPageID() {
        this.allAboutPageID = allAboutPageID;
        this.TheSpeakersPageID = TheSpeakersPageID;
        this.NewsPageID = NewsPageID;
    }
    return NewslandingPageID;
}());
NewslandingPageID = __decorate([
    IonicPage(),
    Component({
...
export { NewslandingPageID };
//# sourceMappingURL=newslanding-id.js.map