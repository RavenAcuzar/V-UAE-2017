...
var VFPPageID = (function () {
    function VFPPageID(navCtrl) {
        this.navCtrl = navCtrl;
        this.TheSpeakersPageID = TheSpeakersPageID;
        this.VPtgPageID = VPtgPageID;
    }
    VFPPageID.prototype.scrollToTop = function () {
...
], VFPPageID.prototype, "content", void 0);
VFPPageID = __decorate([
    Component({
        selector: 'page-vp',
...
export { VFPPageID };
//# sourceMappingURL=vfp-joseph-bismark-id.js.map