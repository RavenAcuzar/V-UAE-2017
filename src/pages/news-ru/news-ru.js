...
var NewsPageRU = (function () {
    function NewsPageRU(navCtrl) {
        this.navCtrl = navCtrl;
        this.NewslandingPageRU = NewslandingPageRU;
        this.TheSpeakersPageRU = TheSpeakersPageRU;
    }
    NewsPageRU.prototype.scrollToTop = function () {
...
], NewsPageRU.prototype, "content", void 0);
NewsPageRU = __decorate([
    Component({
        selector: 'page-news',
...
export { NewsPageRU };
//# sourceMappingURL=news-ru.js.map