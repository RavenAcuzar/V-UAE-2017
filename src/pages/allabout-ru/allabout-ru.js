...
var allAboutPageRU = (function () {
    function allAboutPageRU() {
        this.HomePageRU = HomePageRU;
        this.NewslandingPageRU = NewslandingPageRU;
    }
    return allAboutPageRU;
}());
allAboutPageRU = __decorate([
    IonicPage(),
    Component({
...
export { allAboutPageRU };
//# sourceMappingURL=allabout-ru.js.map