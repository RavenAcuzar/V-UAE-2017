...
var VPftPageID = (function () {
    function VPftPageID(navCtrl) {
        this.navCtrl = navCtrl;
        this.TheSpeakersPageID = TheSpeakersPageID;
        this.VPcmPageID = VPcmPageID;
    }
    VPftPageID.prototype.scrollToTop = function () {
...
], VPftPageID.prototype, "content", void 0);
VPftPageID = __decorate([
    Component({
        selector: 'page-vp',
...
export { VPftPageID };
//# sourceMappingURL=vp-ferdie-tolentino-id.js.map