...
var VPtgPageID = (function () {
    function VPtgPageID(navCtrl) {
        this.navCtrl = navCtrl;
        this.TheSpeakersPageID = TheSpeakersPageID;
        this.VPdiPageID = VPdiPageID;
    }
    VPtgPageID.prototype.scrollToTop = function () {
...
], VPtgPageID.prototype, "content", void 0);
VPtgPageID = __decorate([
    Component({
        selector: 'page-vp',
...
export { VPtgPageID };
//# sourceMappingURL=vp-tg-kintanar-id.js.map