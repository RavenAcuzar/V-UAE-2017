...
var VPcmPageID = (function () {
    function VPcmPageID(navCtrl) {
        this.navCtrl = navCtrl;
        this.TheSpeakersPageID = TheSpeakersPageID;
        this.VPdsPageID = VPdsPageID;
    }
    VPcmPageID.prototype.scrollToTop = function () {
...
], VPcmPageID.prototype, "content", void 0);
VPcmPageID = __decorate([
    Component({
        selector: 'page-vp',
...
export { VPcmPageID };
//# sourceMappingURL=vp-cherian-mathew-id.js.map