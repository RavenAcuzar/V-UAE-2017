...
var VPssPageID = (function () {
    function VPssPageID(navCtrl) {
        this.navCtrl = navCtrl;
        this.TheSpeakersPageID = TheSpeakersPageID;
        this.VPftPageID = VPftPageID;
    }
    VPssPageID.prototype.scrollToTop = function () {
...
], VPssPageID.prototype, "content", void 0);
VPssPageID = __decorate([
    Component({
        selector: 'page-vp',
...
export { VPssPageID };
//# sourceMappingURL=vp-sathi-senathirajah-id.js.map