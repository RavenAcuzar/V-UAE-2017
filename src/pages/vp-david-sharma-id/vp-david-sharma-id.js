...
var VPdsPageID = (function () {
    function VPdsPageID(navCtrl) {
        this.navCtrl = navCtrl;
        this.TheSpeakersPageID = TheSpeakersPageID;
        this.VPmkPageID = VPmkPageID;
    }
    VPdsPageID.prototype.scrollToTop = function () {
...
], VPdsPageID.prototype, "content", void 0);
VPdsPageID = __decorate([
    Component({
        selector: 'page-vp',
...
export { VPdsPageID };
//# sourceMappingURL=vp-david-sharma-id.js.map